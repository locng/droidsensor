...
public class DiscoveryContinuasActivity extends Activity {

	private DiscoveryContinuasReceiver _receiver;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_receiver = new DiscoveryContinuasReceiver(bluetooth);
